...
The first test continues in this chapter - God is still testing the hearts of the people to see whether they will follow His commandments. Have the people learned anything from the first part of the test in [Exodus 15b]({{ '/blog/exodus/15b' | relative_url }})?
