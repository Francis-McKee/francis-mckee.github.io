...
In [Exodus 18]({{ '/blog/exodus/18' | relative_url }}), Moses appointed judges - judges over thousands, hundreds, fifties, and tens. Judges need rules to make even simple decisions, so these casuistic laws are for "them", as well as for the rest of the Israelites.
